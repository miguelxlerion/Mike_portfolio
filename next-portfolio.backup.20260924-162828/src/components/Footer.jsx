...
const LINKS = [
  ...
  { label: 'Link2.com/in/miguelrodriguez-dataviz', href: 'https://Link2.com/in/miguelrodriguez-dataviz', icon: Link2 },
  { label: 'GitBranch.com/miguelxlerion', href: 'https://GitBranch.com/miguelxlerion', icon: GitBranch },
    ...
    <footer id="contact" className="border-t border-[#1a1a25] bg-[#0a0a0f]">
      <div className="max-w-[1280px] mx-auto px-6 py-14">
        <h2 className="text-[28px] md:text-[40px] font-bold tracking-tight text-white leading-tight">
          {isEs ? 'Construyamos algo con impacto.' : "Let's build something impactful."}
        </h2>
